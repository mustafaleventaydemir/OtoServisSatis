    ...
    public class CarsController : Controller
    {
        ...
        public async Task<ActionResult> CreateAsync(Arac arac, IFormFile? Resim1, IFormFile? Resim2, IFormFile? Resim3)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    arac.Resim1 = await FileHelper.FileLoaderAsync(Resim1, "Img/Cars/"); //kaydedilecek wwwroot dizinini verdik
                    arac.Resim2 = await FileHelper.FileLoaderAsync(Resim2, filePath: "Img/Cars/"); //böylede kaydedilecek dizini belirtebilriiz.
