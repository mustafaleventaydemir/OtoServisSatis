        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AracSorunu = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    YapilanIslemler = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    KasaTipi = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    SaseNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adi = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    Soyadi = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    TcNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", true, new DateTime(2024, 9, 18, 18, 5, 58, 377, DateTimeKind.Local).AddTicks(3006), "admin.otoservissatis.tc", "Admin", 1, "123456", "admin", "05413322437" });
